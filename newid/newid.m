...
set(InputFig,'Position',getnicedialoglocation_enter(FigPos,get(InputFig,'Units')));
...
setdefaultbutton_enter(InputFig, OKHandle);
...
function figure_size = getnicedialoglocation_enter(figure_size, figure_units)
...
function setdefaultbutton_enter(figHandle, btnHandle)
